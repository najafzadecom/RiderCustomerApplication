...
class ListtrashOne1ItemWidget extends StatelessWidget {
  ListtrashOne1ItemWidget(this.listtrashOne1ItemModelObj);

  ListtrashOne1ItemModel listtrashOne1ItemModelObj;

  var controller = Get.find<Iphone8TwentyfourController>();
